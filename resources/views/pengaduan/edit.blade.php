...
<div class="container">
    <div class="row justify-content-center">
        ...
        {{ method_field('PATCH') }}
            <div class="card">
                <div class="card-header">Ubah Pengaduan</div>

                <div class="card-body">
                    {{-- <input type="hidden" name="user_id" value="{{ Auth::user()->id }}"> --}}
                    <div class="form-group">
                      <label for="inputSiswaID" class="form-label">Nama Siswa</label>
                      <select name="siswa_id" id="inputSiswaID" class="form-select" required>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="lokasi" class="form-control @error('lokasi') is-invalid @enderror" value="{{ $pengaduan->lokasi }}">
                    </div>
                    <div class="form-group">
                      <label for="keterangan">Keterangan</label>
                      <textarea name="keterangan" class = "form-control @error('keterangan') is-invalid @enderror">{{ $pengaduan->keterangan }}</textarea>
                      @error('keterangan')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
